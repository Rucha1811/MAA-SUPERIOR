...
const ALA_CARTE: Record<string, { note?: string; items: string[] }> = {
  ...
  'Hot Sweet Dishes': { note: 'Choose any One', items: ['Stuffed Gulab Jamun','Kala Jamun','Mava Bati','Boondi with Rabdi','Jalebi Kesaria','Mal Puva','Imerti','Mung Ki Dal Ka Halwa','Doodh Pak','Kheer','Gajar Ka Halwa (Seasonal)','Jalebi with Rabdi','Gulab Jamun with Rubadi','Mal Puva with Kheer','Khajoor Ki Bedmi','Anjeer Ki Bedmi','Anjeer Halwa','Neela Nariyal Ka Halwa','Hot Dry Fruit Halwa','Puran Puri','Tawa Mithai (Bengali Jalwa)'] },
  ...
  'Garvi Gujarat': { items: ['Khati-Mithi Kadhi','Khichadi','Bazara Ni Roti + Makhan','Ringan-Bataka Nu Saag','Pudina Garlic Green Chatni','Makai Ka Handwa','Chhash'] },
